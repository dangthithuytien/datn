      ...
      >
        <div className="row align-items-center">
          ...
          <div className="col-4 d-flex justify-content-end align-items-center gap-3">
            ...
            <div
              className="icon-text text-center position-relative"
              onMouseEnter={() => handleMouseEnter(setTraCuuDropdownOpen)}
              onMouseLeave={() => handleMouseLeave(setTraCuuDropdownOpen)}
              style={{ cursor: "pointer" }}
            >
              <FaBookOpen />
                  ...
                  <li className="position-relative">
                    ...
                    {orderDropdownOpen && (
                      <ul className="dropdown-submenu list-unstyled m-0">
                        <li><a className="dropdown-item" href="/orders-all">Đơn hàng mua</a></li>
                        <li><a className="dropdown-item" href="/orders-rent">Đơn hàng thuê</a></li>
                      </ul>
                    )}
                  </li>
            ...
            {/* === YÊU THÍCH === */}
            <a href="/favorite" className="icon-text text-center" style={{ textDecoration: "none", color: "inherit" }}>
